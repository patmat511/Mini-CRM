...
final class RolesController extends AbstractController
{
    ...
    #[Route('/{roleId}', name: 'app_roles_show', methods: ['GET'])]
    ...
    #[Route('/{roleId}/edit', name: 'app_roles_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{roleId}', name: 'app_roles_delete', methods: ['POST'])]
    public function delete(Request $request, Roles $role, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$role->getRoleId(), $request->getPayload()->getString('_token'))) {
