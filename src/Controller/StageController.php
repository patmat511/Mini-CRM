...
final class StageController extends AbstractController
{
    ...
    #[Route('/{stageId}', name: 'app_stage_show', methods: ['GET'])]
    ...
    #[Route('/{stageId}/edit', name: 'app_stage_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{stageId}', name: 'app_stage_delete', methods: ['POST'])]
    public function delete(Request $request, Stage $stage, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$stage->getStageId(), $request->getPayload()->getString('_token'))) {
